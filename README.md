...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/azure-core-cpp-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/azure-core-cpp-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add azure-core-cpp
# for installing globally
pixi global install azure-core-cpp
```
...
It is possible to list all of the versions of `azure-core-cpp` available on your platform:
...
```
pixi search azure-core-cpp --channel conda-forge
```
